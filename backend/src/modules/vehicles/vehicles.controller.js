...
const create = async (req, res) => sendData(res, await service.createVehicle(vehicleSchema.parse(req.body)), 201);
const update = async (req, res) => sendData(res, await service.updateVehicle(req.params.id, vehicleSchema.partial().parse(req.body)));
